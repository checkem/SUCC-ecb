    ...
    SUCC_CHANNELED_HEALS_SPELLCASTS_TO_TRACK = {
            -- FIRST AID
    ...
    SUCC_CHANNELED_SPELLCASTS_TO_TRACK = {
            -- HUNTER
    ...
    SUCC_INSTANT_SPELLCASTS_TO_TRACK = {
            -- DRUID
		['Moonfire']         = true,
            -- MAGE
    ...
    SUCC_TIME_MODIFIER_BUFFS_TO_TRACK = {
        ['Barkskin']                    = {1.4, {'all'}},
